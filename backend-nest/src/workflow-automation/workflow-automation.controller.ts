...
export class WorkflowAutomationController {
  ...
  @Delete('workflows/:id')
  async deleteWorkflow(@Param('id') id: string, @Req() req: AuthenticatedRequest) {
  ...
  async getExecutions(@Param('id') workflowId: string, @Req() req: AuthenticatedRequest) {
    return this.workflowAutomationService.getExecutions(workflowId, req.user.workspaceId);
  }

  @Get('executions/:id')
  async getExecution(@Param('id') executionId: string, @Req() req: AuthenticatedRequest) {
    return this.workflowAutomationService.getExecution(executionId, req.user.workspaceId);
  }

  @Post('executions/:id/retry')
  async retryExecution(@Param('id') executionId: string, @Req() req: AuthenticatedRequest) {
